    ...
    this.reloadSettings = function () {
     ...
     this.create = function (io) {
        ...
        function routeProducedMessage (realmId, obj, registerProducer) {
            ...
            deliverToSseSinks(realmId, event,
                buildSseFrame(event, message, producerName, {enc: obj.enc, to: obj.to, contentType: obj.contentType}),
                obj.id);
        ...
        function handleHttpPublishRequest (req, res) {
            ...
            readRawBody(req, HTTP_PUBLISH_MAX_BODY, function (bodyErr, bodyBuf, tooLarge) {
                ...
                validateToken(token, realm).then(function (authResult) {
                    ...
                    var msgId = 'http-' + crypto.randomBytes(12).toString('hex');
        ...
        function handleSseSubscribeRequest (req, res, url, ip) {
            ...
            var proceed = function () {
                ...
                openSseStream(req, res, realm, event, ip);
            };
        ...
        function openSseStream (req, res, realm, event, ip) {
            res.writeHead(200, {
