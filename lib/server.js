    ...
    this.start = function (p) {
     ...
     this.create = function (io) {
        ...
        io.sockets.on('connection', function(socket) {
             ...
             * 
             * we need to send two sets of messages one for single event reciveer and one for all-event recievers
             * 
             */
            ...
            function sendConsumeMessage (socketId, event, message, producer) {
                ...
                sendMessage(socketId, eventAll, msgObj);
                sendMessage(socketId, eventStr, msgObj);
            }
            ...
            function broadcastConsumeMessage (event, message, producer) {
                ...
                broadcastMessage(eventAll, msgObj);
