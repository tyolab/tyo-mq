    ...
    this.reloadSettings = function () {
     ...
     this.create = function (io) {
        ...
        io.sockets.on('connection', function(socket) {
             ...
             * socket; offline recipients just get an ack for now (durable
             * store-and-forward is a follow-up — see Task 7).
            ...
            onAuthorized('SEALED_DELIVER', ['producer', 'consumer'], function (msg, callback) {
                ...
                if (sock) {
                    ...
                    // TEMPORARY — Task 7 replaces this with a durable enqueue.
                    if (callback) callback({ok: true, delivered: 'offline-unqueued'});
                }
            });
